...
function extractTooManyRequestsInfo(html) {
  var _a, _b, _c;
  const ip = ((_a = html.match(/IP address: (.+?)<br>/)) == null ? void 0 : _a[1]) || "";
  const time = ((_b = html.match(/Time: (.+?)<br>/)) == null ? void 0 : _b[1]) || "";
  const url = (((_c = html.match(/URL: (.+?)<br>/)) == null ? void 0 : _c[1]) || "").replace(/&amp;/g, "&");
  return { ip, time, url };
}
...
var Translator = class {
  ...
  async translate() {
    ...
    const res = await lib_default(url, fetchOptions);
    if (!res.ok)
...
http-errors/index.js:
   ...
   *)
*/
//# sourceMappingURL=@vitalets_google-translate-api.js.map
